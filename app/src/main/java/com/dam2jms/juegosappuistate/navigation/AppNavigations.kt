...
fun appNavigation() {
    ...
    NavHost(navController = navController, startDestination = AppScreens.MainScreen.route) {
        ...
        composable(route = AppScreens.NonesScreen.route) { nonesScreenState(navController, mvvm = ViewModelNonesState()) }
        composable(route = AppScreens.PiedraScreen.route) { piedraScreenState(navController, mvvm = ViewModelPiedraState()) }
